...
var goldenNames = [
  "Sugar Smuggling Minor",
  "Unlucky Crafter",
  "Code Mob",
  "Shadow Dev",
  "Really Bad Dev",
  "Abstract Melon",
  "Really Bad Drug Lord",
  "Macky Water",
  "Warehouse Owning Warehouse Owner",
  "Enslaved Minor",
  "Melon",
  "Toki",
];
async function randomName(overwrite = false) {
  ...
  var name =
    "this shouldn't be your name and if it does then something probably went wrong";
  if (Math.random() > 0.125) {
    name =
      nameAdjs[Math.floor(Math.random() * nameAdjs.length)] +
      " " +
    ...
    if (mode == 0) {
      name =
        creatorNameAdjs[Math.floor(Math.random() * creatorNameAdjs.length)] +
        " " +
        nameNouns[Math.floor(Math.random() * nameNouns.length)];
    } else if (mode == 1) {
      name =
        nameAdjs[Math.floor(Math.random() * nameAdjs.length)] +
        " " +
        creatorNameNouns[Math.floor(Math.random() * creatorNameNouns.length)];
    } else if (mode == 2) {
      name =
        creatorNameAdjs[Math.floor(Math.random() * creatorNameAdjs.length)] +
        " " +
